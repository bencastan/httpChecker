...
from httpChecker.cli import read_user_cli_args, display_check_result
from httpChecker.checker import site_is_online, site_is_online_async
...
def main():
    ...
    if user_args.asynchronous:
        asyncio.run(_asynchronous_checks(urls))
    else:
...
async def _asynchronous_checks(urls):
